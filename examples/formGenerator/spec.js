        ...
        },
        {
          ...
          elements: [
            ...
            },
            {
              ...
              required: true,
              value: '',
              validation: 'value <= _values.well_depth',
              error: 'Значение не должно превышать глубину скважины.',
            }
          ],
          children: [{
    ...
    },
    {
      ...
      children: [{
        ...
        },
        {
          ...
          validation: 'value > _values.well.layers.layer[index].from && value <= _values.well.depth',  // _values.well.layers.layer[length - 1].to === _values.well_depth &&
        }]
      }]
    }
  ]
